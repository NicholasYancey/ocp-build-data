...
ENV __doozer=update BUILD_RELEASE=202606170754.p2.g123934a.assembly.test.el10 BUILD_VERSION=v5.0.0 OS_GIT_MAJOR=5 OS_GIT_MINOR=0 OS_GIT_PATCH=0 OS_GIT_TREE_STATE=clean OS_GIT_VERSION=5.0.0-202606170754.p2.g123934a.assembly.test.el10 SOURCE_GIT_TREE_STATE=clean __doozer_group=openshift-5.0 __doozer_key=openshift-base-rhel10 __doozer_uuid_tag=base-rhel10-v5.0.0-20260617.075443 __doozer_version=v5.0.0 
ENV __doozer=merge OS_GIT_COMMIT=123934a OS_GIT_VERSION=5.0.0-202606170754.p2.g123934a.assembly.test.el10-123934a SOURCE_DATE_EPOCH=1781185697 SOURCE_GIT_COMMIT=123934ab0a00906bc9b3b82e5eb5061fa1a8b39b SOURCE_GIT_TAG=123934ab0 SOURCE_GIT_URL=https://github.com/openshift-eng/ocp-build-data 
...
LABEL \
        ...
        version="v5.0.0" \
        release="202606170754.p2.g123934a.assembly.test.el10" \
